...
on the github [releases](https://github.com/gablank/discordgo/releases) page.
...
```sh
cd $GOPATH/src/github.com/gablank/discordgo
...
```go
import "github.com/gablank/discordgo"
```
...
- [![GoDoc](https://godoc.org/github.com/gablank/discordgo?status.svg)](https://godoc.org/github.com/gablank/discordgo) 
- [![Go Walker](http://gowalker.org/api/v1/badge)](https://gowalker.org/github.com/gablank/discordgo) 
...
- [DiscordGo Examples](https://github.com/gablank/discordgo/tree/master/examples) - A collection of example programs written with DiscordGo
- [Awesome DiscordGo](https://github.com/gablank/discordgo/wiki/Awesome-DiscordGo) - A curated list of high quality projects using DiscordGo

## Troubleshooting
For help with common problems please reference the 
[Troubleshooting](https://github.com/gablank/discordgo/wiki/Troubleshooting) 
