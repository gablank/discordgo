...
[Awesome DiscordGo](https://github.com/gablank/discordgo/wiki/Awesome-DiscordGo) list :).
...
release notes on the github [releases](https://github.com/gablank/discordgo/releases) 
page.
